...
// Request permission to receive notifications and get the FCM token
const requestPermission = async () => {
  try {
    // Request notification permission
    await Notification.requestPermission();
    // Get the FCM token
    const token = await getToken(messaging, { vapidKey: 'BEYcL6SiowVRB5LByLbGXn_vhVv9CsH1SIEIyA6GKtUDDjLhDvj0XUuUV6arh8ZZEgLBETuAc8yHAdAbg51WV1s' });
    ...
    // You can send this token to your backend to store it (for sending push notifications later)
  } catch (error) {
